    ...
    <>
      ...
      <li tabIndex={0}>
        <Link
          ...
          className={
            activeNav === "/class"
              ? "font-bold  text-primary hover:bg-indigo-500"
      ...
      <li tabIndex={0}>
        <Link
          to="/dashbord/myClass"
          onClick={() => setActiveNav("/dashbord/myClass")}
          className={
            activeNav === "/dashbord/myClass"
              ? "font-bold  text-primary hover:bg-indigo-500"
              : "font-bold justify-between "
          }
        >
    ...
    <div className="container mx-auto">
      <nav className="navbar">
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal">{navbarOption}</ul>
        </div>
        ...
        <button
          className={`btn btn-primary mx-2 ${
            theme === "light" ? "dark:bg-white" : "dark:bg-black"
          }`}
          onClick={toggleTheme}
        >
